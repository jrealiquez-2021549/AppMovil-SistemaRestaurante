...
export const createReservation = async (req, res) => {
    try {
        ...
        // Bug fix: al crear la reservación, la mesa pasa a estado RESERVED automáticamente
...
export const updateReservationStatus = async (req, res) => {
    try {
        ...
        // Bug fix: si la reservación se cancela o completa, la mesa vuelve a AVAILABLE
