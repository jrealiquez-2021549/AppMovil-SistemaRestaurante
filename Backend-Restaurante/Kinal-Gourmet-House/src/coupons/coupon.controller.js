...
export const updateCoupon = async (req, res) => {
    try {
        ...
        if (req.body.code && req.body.code.toUpperCase() !== currentCoupon.code && currentCoupon.usedCount > 0) {
            return res.status(400).json({
                success: false,
        ...
        // Validar rango de discountValue según el tipo de descuento
        const discountType = req.body.discountType ?? currentCoupon.discountType;
        const discountValue = req.body.discountValue ?? currentCoupon.discountValue;
        ...
        const validFrom = req.body.validFrom ?? currentCoupon.validFrom;
        const validUntil = req.body.validUntil ?? currentCoupon.validUntil;
